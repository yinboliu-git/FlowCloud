"""
Training script for 2D simulation dataset.

This script trains and evaluates the TransformerLatentODE model on simulated 2D
spatial-temporal point cloud data with gene expression.
"""
...
def main_run_pipeline(config_path='config.yaml', dataset_name='simulation_2d'):
    """
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='Train and evaluate model on 2D simulation dataset'
    )
    parser.add_argument('--config', type=str, default='config.yaml',
                       help='Path to configuration file')
    parser.add_argument('--dataset', type=str, default='simulation_2d',
